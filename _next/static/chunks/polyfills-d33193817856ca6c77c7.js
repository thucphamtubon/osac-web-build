      ...
      (function(t) {
        !(function() {
          ...
          var Vt =
            ...
            Ht = Bt('unscopables'),
            Xt = Array.prototype;
          null == Xt[Ht] && P.f(Xt, Ht, { configurable: !0, value: Vt(null) });
          var Yt = function(t) {
            Xt[Ht][t] = !0;
          };
              ...
              var Jo = function(t, e) {
                  ...
                  Xo
                    ...
                    Yo &&
                      (r = !!e && e.indexOf('y') > -1) &&
                      (e = e.replace(/y/g, ''));
                  var a = Rr(Xo ? new Go(t, e) : Go(t, e), n ? this : $o, Jo);
          ...
          var Hi = mt.f,
            ...
            Ji = {
              f: function(t) {
                return Yi && '[object Window]' == Xi.call(t)
                  ? (function(t) {
                      try {
                        return Hi(t);
                      } catch (t) {
          ...
          kt(
            ...
            te('String', 'endsWith');
          var Ha = String.fromCharCode,
            Xa = String.fromCodePoint;
          kt(
            { target: 'String', stat: !0, forced: !!Xa && 1 != Xa.length },
            {
              fromCodePoint: function(t) {
                for (
                  ...
                  n.push(
                    e < 65536
                      ? Ha(e)
                      : Ha(55296 + ((e -= 65536) >> 10), (e % 1024) + 56320)
                  );
                }
                return n.join('');
              },
            ...
            (a &&
              qt(rc, {
                ...
                pathname: vc(lc, function(t) {
                  var e = rs(this);
                  e.cannotBeABaseURL || ((e.path = []), tc(e, t + '', Xs));
                }),
              ...
              Df &&
                ...
                (this.arrayBuffer = function() {
                  return this._bodyArrayBuffer
                    ? Xf(this) || Promise.resolve(this._bodyArrayBuffer)
                    : this.blob().then(Jf);
                })),
              (this.text = function() {
                var t,
          ...
          (Hf.prototype.append = function(t, e) {
            (t = Gf(t)), (e = $f(e));
            var r = this.map[t];
            this.map[t] = r ? r + ', ' + e : e;
          }),
            (Hf.prototype.delete = function(t) {
              delete this.map[Gf(t)];
            }),
            (Hf.prototype.get = function(t) {
              return (t = Gf(t)), this.has(t) ? this.map[t] : null;
            }),
            (Hf.prototype.has = function(t) {
              return this.map.hasOwnProperty(Gf(t));
            }),
            (Hf.prototype.set = function(t, e) {
              this.map[Gf(t)] = $f(e);
            }),
            (Hf.prototype.forEach = function(t, e) {
              for (var r in this.map)
                this.map.hasOwnProperty(r) && t.call(e, this.map[r], r, this);
            }),
            (Hf.prototype.keys = function() {
              var t = [];
              return (
            ...
            Bf && (Hf.prototype[Symbol.iterator] = Hf.prototype.entries);
          ...
          function el(t, e) {
            ...
            if (t instanceof el) {
              ...
              (this.url = t.url),
                ...
                e.headers || (this.headers = new Hf(t.headers)),
