    ...
    'w/UT': function(e, t, n) {
        ...
        return Br || null == Qr || Qr !== fn(n)
          ...
          : ('selectionStart' in (n = Qr) && hn(n)
            ...
            Hr && Vr(Hr, n)
              ? null
              : ((Hr = n),
                ((e = Hn.getPooled(Wr.select, $r, e, t)).type = 'select'),
                (e.target = Qr),
                An(e),
                e));
      }
      ...
      function Kl() {
        if (!Al && null !== Dl) {
          ...
          try {
            ...
            throw (null !== Dl && (Dl = Dl.slice(e + 1)), Tl(Pl, Bl), n);
          } finally {
            Al = !1;
          }
        }
      ...
      function qi(e, t, n, r, l, i) {
        if (
          ...
          (t.updateQueue = null),
          (t.expirationTime = 0),
          (Ui.current = null === e || null === e.memoizedState ? ga : ya),
          (e = n(r, l)),
          t.expirationTime === ji)
        ) {
          i = 0;
      ...
      function ha(e, t, n) {
        ...
        if (
          ...
          (Hi = !0), (l.expirationTime = ji), (Wi.expirationTime = ji);
        else {
          if (
            0 === e.expirationTime &&
      ...
      function Jo(e) {
        if (0 !== e.lastExpiredTime)
          (e.callbackExpirationTime = 1073741823),
            ...
            (e.callbackNode = Hl(eu.bind(null, e)));
        else {
          var t = Go(e),
            n = e.callbackNode;
          if (0 === t)
