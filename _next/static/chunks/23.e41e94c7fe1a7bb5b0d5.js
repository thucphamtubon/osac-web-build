    ...
    GfiW: function(e, t, n) {
        ...
        p = (function(e, t) {
          ...
          n.Controller = function(o) {
            var i,
              ...
              b = function() {
                d.refreshInterval > 0 &&
                  (a = e.setTimeout(T, d.refreshInterval));
              },
              w = function() {
                return d.vertical
              ...
              C = function() {
                if (y && p) {
                  var e = s.type.Array(p) ? p : f.slice(0);
                  p = !1;
                  var t = g,
                    n = (g = u.scrollPos()) - t;
            ...
            return (
              (this.addScene = function(e) {
                if (s.type.Array(e))
                  ...
                  if (e.controller() !== u) e.addTo(u);
                    ...
                    x(3, 'adding Scene (now ' + f.length + ' total)');
                  }
                } else
              ...
              (this.removeScene = function(e) {
                if (s.type.Array(e))
                  ...
                  t > -1 &&
                    ...
                    f.splice(t, 1),
                    x(3, 'removing Scene (now ' + f.length + ' left)'),
                    e.remove());
                }
                return u;
              }),
              ...
              (this.update = function(e) {
                return _({ type: 'resize' }), e && C(), u;
              }),
              (this.scrollTo = function(e, t) {
                if (s.type.Number(e)) S.call(d.container, e, t);
                else if (e instanceof n.Scene)
                  e.controller() === u
                ...
                else if (s.type.Function(e)) S = e;
                else {
                  var r = s.get.elements(e)[0];
                  if (r) {
                    for (
                      ;
                      r.parentNode.hasAttribute('data-scrollmagic-pin-spacer');
                    ...
                    var o = d.vertical ? 'top' : 'left',
                      ...
                      a = s.get.offset(r);
                    v || (i[o] -= u.scrollPos()), u.scrollTo(a[o] - i[o], t);
                  } else
                    x(
                      2,
              ...
              (this.loglevel = function(e) {
                return arguments.length
                  ? (d.loglevel != e && (d.loglevel = e), u)
                  : d.loglevel;
              }),
              (this.enabled = function(e) {
                return arguments.length
                  ? (y != e && ((y = !!e), u.updateScene(f, !0)), u)
                  : y;
              }),
              (this.destroy = function(t) {
                ...
                return (
                  d.container.removeEventListener('resize', _),
                  d.container.removeEventListener('scroll', _),
                  s.cAF(i),
                  x(
                    3,
                    'destroyed ' +
              ...
              (function() {
                for (var r in d)
                  c.hasOwnProperty(r) ||
                    (x(2, 'WARNING: Unknown option "' + r + '"'), delete d[r]);
                if (
                ...
                (v =
                  d.container === e ||
                  d.container === t.body ||
                  !t.body.contains(d.container)) && (d.container = e),
                  (m = E()),
                  d.container.addEventListener('resize', _),
                  d.container.addEventListener('scroll', _);
                var o = parseInt(d.refreshInterval, 10);
                (d.refreshInterval = s.type.Number(o) ? o : c.refreshInterval),
                  b(),
                  x(3, 'added new ' + l + ' controller (v' + n.version + ')');
              })(),
              u
            );
          };
          ...
          (n.Controller.addOption = function(e, t) {
            ...
            (n.Scene = function(r) {
                ...
                return (
                  s.type.Function(t)
                    ? (e = e.trim().split(' ')).forEach(function(e) {
                        ...
                        '*' != r &&
                          (m[r] || (m[r] = []),
                          m[r].push({ namespace: o || '', callback: t }));
                      })
                    : y(
                        1,
                  ...
                  return e
                    ? ((e = e.trim().split(' ')).forEach(function(e, n) {
                        var r = e.split('.'),
                          o = r[0],
                          i = r[1] || '';
                        ('*' === o ? Object.keys(m) : [o]).forEach(function(e) {
                ...
                (this.trigger = function(e, t) {
                  if (e) {
                    var r = e.trim().split('.'),
                      ...
                      i = r[1],
                      s = m[o];
                    y(3, 'event fired:', o, t ? '->' : '', t || ''),
                      s &&
                        s.forEach(function(e, r) {
                          (i && i !== e.namespace) ||
                            e.callback.call(
                              u,
                              new n.Event(o, e.namespace, u, t)
                            );
                        });
                ...
                (this.progress = function(e) {
                  if (arguments.length) {
                    ...
                    if (
                      ...
                      var i = { progress: p, state: f, scrollDirection: r },
                        s = f != n,
                        l = function(e) {
                          u.trigger(e, i);
                        };
              ...
              var b,
                ...
                E = function() {
                  (g = { start: h + d.offset }),
                    a &&
                      d.triggerElement &&
                      (g.start -= a.info('size') * d.triggerHook),
                ...
                T = function(e) {
                  (e = arguments.length ? [e] : Object.keys(_)).forEach(
                    function(e, t) {
                      var n;
                      if (_[e])
                        try {
                ...
                x = function(e, t) {
                  var n = !1,
                    r = d[e];
                  return d[e] != t && ((d[e] = t), T(e), (n = r != d[e])), n;
                },
                O = function(e) {
                  u[e] ||
                    (u[e] = function(t) {
              ...
              var P = function(e) {
                  if (b && a) {
                    ...
                    if (e || 'DURING' !== f) {
                      var r = {
                        ...
                        o = s.css(n, 'position') != r.position;
                      w.pushFollowers
                        ? d.duration > 0 &&
                          (('AFTER' === f &&
                            0 === parseFloat(s.css(w.spacer, 'padding-top'))) ||
                            ('BEFORE' === f &&
                              0 ===
                                parseFloat(
                                  s.css(w.spacer, 'padding-bottom')
                                ))) &&
                          (o = !0)
                        : (r[t.vertical ? 'top' : 'left'] = d.duration * p),
                        s.css(n, r),
                        o && G();
                    } else {
                      'fixed' != s.css(n, 'position') &&
                        (s.css(n, { position: 'fixed' }), G());
                      var i = s.get.offset(w.spacer, !0),
                        l =
                          d.reverse || 0 === d.duration
                            ? t.scrollPos - g.start
                            : Math.round(p * d.duration * 10) / 10;
                      (i[t.vertical ? 'top' : 'left'] += l),
                        s.css(w.spacer.firstChild, {
                          top: i.top,
                          left: i.left,
                        });
                    }
                ...
                G = function() {
                  if (b && a && w.inFlow) {
                    var e = 'DURING' === f,
                      t = a.info('vertical'),
                      n = w.spacer.firstChild,
                      r = s.isMarginCollapseType(s.css(w.spacer, 'display')),
                      o = {};
                    w.relSize.width || w.relSize.autoFullWidth
                      ? e
                        ? s.css(b, { width: s.get.width(w.spacer) })
                        : s.css(b, { width: '100%' })
                      : ((o['min-width'] = s.get.width(t ? b : n, !0, !0)),
                        ...
                        ? e
                          ? s.css(b, {
                              height:
                                ...
                                (w.pushFollowers ? d.duration : 0),
                            })
                          : s.css(b, { height: '100%' })
                        : ((o['min-height'] = s.get.height(t ? n : b, !0, !r)),
                          (o.height = e ? o['min-height'] : 'auto')),
                      w.pushFollowers &&
                        ((o['padding' + (t ? 'Top' : 'Left')] = d.duration * p),
                ...
                N = function() {
                  a && b && 'DURING' === f && !a.info('isDocument') && P();
                },
                I = function() {
                  a &&
                    b &&
                    'DURING' === f &&
                    (((w.relSize.width || w.relSize.autoFullWidth) &&
                      s.get.width(e) != s.get.width(w.spacer.parentNode)) ||
                      (w.relSize.height &&
                        s.get.height(e) !=
                          s.get.height(w.spacer.parentNode))) &&
                    G();
                },
                L = function(e) {
                  a &&
              ...
              (this.setPin = function(n, r) {
                var o = r && r.hasOwnProperty('pushFollowers');
                if (
                  ((r = s.extend(
                    {},
                    {
                ...
                var i = (b = n).parentNode.style.display,
                  a = [
                    'top',
                    'left',
                    'bottom',
                ...
                var l = 'absolute' != s.css(b, 'position'),
                  c = s.css(b, a.concat(['display'])),
                  f = s.css(b, ['width', 'height']);
                (b.parentNode.style.display = i),
                  !l &&
                    r.pushFollowers &&
                    (y(
                      2,
                ...
                var p = b.parentNode.insertBefore(t.createElement('div'), b),
                  g = s.extend(c, {
                ...
                if (
                  (l || s.extend(g, s.css(b, ['width', 'height'])),
                  s.css(p, g),
                  p.setAttribute('data-scrollmagic-pin-spacer', ''),
                  s.addClass(p, r.spacerClass),
                  (w = {
                    spacer: p,
                    relSize: {
                      ...
                      autoFullWidth:
                        'auto' === f.width &&
                        l &&
                        s.isMarginCollapseType(c.display),
                    },
                ...
                return (
                  w.relSize.width && s.css(p, { width: f.width }),
                  w.relSize.height && s.css(p, { height: f.height }),
                  p.appendChild(b),
                  s.css(b, {
                    position: l ? 'relative' : 'absolute',
                    margin: 'auto',
                ...
                (this.removePin = function(t) {
                  if (b) {
                    if (('DURING' === f && P(!0), t || !a)) {
                      ...
                      w.spacer.parentNode.insertBefore(n, w.spacer),
                    ...
                    e.removeEventListener('scroll', N),
                      ...
                      b.removeEventListener('DOMMouseScroll', L),
                      (b = void 0),
                      y(
                        3,
              ...
              return (
                ...
                (this.setClassToggle = function(e, t) {
                  var n = s.get.elements(e);
                  return 0 !== n.length && s.type.String(t)
                    ? (z.length > 0 && u.removeClassToggle(),
                      (F = t),
                      (z = n),
                      u.on(
                        ...
                        function(e) {
                          var t =
                            'enter' === e.type ? s.addClass : s.removeClass;
          ...
          (n.Scene.addOption = function(e, t, r, i) {
            e in o.defaults
              ? n._util.log(
                  1,
          ...
          var s = (n._util = (function(e) {
            var n,
              ...
              a = function(n, r, i, a) {
                if ((r = r === t ? e : r) === e) a = !1;
                else if (!v.DomElement(r)) return 0;
                n = n.charAt(0).toUpperCase() + n.substr(1).toLowerCase();
                var l =
                  (i
                    ? r['offset' + n] || r['outer' + n]
                    : r['client' + n] || r['inner' + n]) || 0;
                if (i && a) {
                  var c = s(r);
                  l +=
                    'Height' === n
                      ? o(c.marginTop) + o(c.marginBottom)
                      : o(c.marginLeft) + o(c.marginRight);
                }
                return l;
              },
              l = function(e) {
            ...
            for (n = 0; !d && n < u.length; ++n)
              (d = e[u[n] + 'RequestAnimationFrame']),
                (f =
                  e[u[n] + 'CancelAnimationFrame'] ||
                  e[u[n] + 'CancelRequestAnimationFrame']);
            d ||
              (d = function(t) {
            ...
            var p = ['error', 'warn', 'log'],
              g = e.console || {};
            for (g.log = g.log || function() {}, n = 0; n < p.length; n++) {
              var h = p[n];
              g[h] || (g[h] = g.log);
            }
            r.log = function(e) {
            ...
            return (
              (m.elements = function(n) {
                ...
                else (v.DomElement(n) || n === t || n === e) && (r = [n]);
                return r;
              }),
              ...
              (m.offset = function(e, t) {
                ...
                if (e && e.getBoundingClientRect) {
                  ...
                  (n.top = r.top),
                    (n.left = r.left),
                    t || ((n.top += m.scrollTop()), (n.left += m.scrollLeft()));
                }
                return n;
              }),
              ...
              (r.css = function(e, t) {
                ...
                for (var o in t) {
                  var i = t[o];
                  i == parseFloat(i) && (i += 'px'), (e.style[l(o)] = i);
                }
              }),
              r
            );
            ...
            a(t, [
              {
                ...
                value: function() {
                  var e = this.props,
                    t = (e.children, u(e, ['children']));
                  this.setState({ controller: new p.Controller(t) });
                },
              },
              {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  return t ? o.a.createElement(g.Provider, { value: t }, e) : e;
                },
              },
            ]),
            t
      ...
      !(function(e) {
        ...
        if ('undefined' === typeof n)
          var n = { addEventListener: function() {} };
        var r = n.console || {},
          o = Function.prototype.bind.call(
            r.error || r.log || function() {},
            r
          );
        e ||
          o(
            ...
            return (
              ...
              (this._indicators.updateBoundsPositions = function(e) {
                for (
                  ...
                  for (
                    t = (r = o[a]).members.length,
                      n = i.get[f](r.element.firstChild);
                    t--;

                  )
                    (u[d] = p - n), i.css(r.members[t].bounds, u);
              }),
              (this._indicators.updateTriggerGroupPositions = function(e) {
                for (
                  var t,
                    ...
                    f = d.length,
                    p = a ? document.body : s,
                    g = a ? { top: 0, left: 0 } : i.get.offset(p, !0),
                    h = l ? i.get.width(s) - 15 : i.get.height(s) - 15,
                    v = l ? 'width' : 'height',
                    m = l ? 'Y' : 'X';
                  f--;
                  ...
                  (n = (t = d[f]).element),
                    (u =
                      (o = t.triggerHook * r.info('size')) >
                      i.get[v](n.firstChild.firstChild)
                        ? 'translate' + m + '(-100%)'
                        : ''),
                    i.css(n, {
              ...
              (this._indicators.updateTriggerGroupLabel = function(e) {
                ...
                n.textContent !== t &&
                  ((n.textContent = t), l && c.updateBoundsPositions());
              }),
              ...
              (this.destroy = function() {
                s.removeEventListener('resize', d),
                  a ||
                    (n.removeEventListener('resize', d),
        ...
        var a = function(e, n) {
            var r,
              ...
              a = this,
              c = l.bounds(),
              u = l.start(n.colorStart),
              d = l.end(n.colorEnd),
              f = n.parent && i.get.elements(n.parent)[0],
              p = function() {
                e._log &&
                  (Array.prototype.splice.call(
                    arguments,
            ...
            (n.name = n.name || s),
              (u.firstChild.textContent += ' ' + n.name),
              ...
              (this.add = function() {
                (o = e.controller()), (r = o.info('vertical'));
                var t = o.info('isDocument');
                f || (f = t ? document.body : o.info('container')),
                  t ||
                    'static' !== i.css(f, 'position') ||
                    i.css(f, { position: 'relative' }),
            ...
            var g = function() {
              ...
              m = function() {
                ...
                (t[r ? 'top' : 'left'] = e.triggerPosition()),
                  ...
                  i.css(c, t),
                  i.css(d, { display: e.duration() > 0 ? '' : 'none' });
              },
              y = function() {
                o._indicators.groups.splice(
                  o._indicators.groups.indexOf(a.triggerGroup),
                  1
                ),
              ...
              b = function() {
                ...
                if (
                  !(
                    a.triggerGroup &&
                    Math.abs(a.triggerGroup.triggerHook - t) < 1e-4
                  )
                ) {
                  for (var s, c = o._indicators.groups, u = c.length; u--; )
                    if (((s = c[u]), Math.abs(s.triggerHook - t) < 1e-4))
                      return (
                        a.triggerGroup &&
                        ...
                        s.members.push(a),
                        (a.triggerGroup = s),
                        void o._indicators.updateTriggerGroupLabel(s)
                      );
                  if (a.triggerGroup) {
                    if (1 === a.triggerGroup.members.length)
                      return (
                        (a.triggerGroup.triggerHook = t),
                  ...
                  !(function() {
                    var t = l.trigger(n.colorTrigger),
                      s = {};
                    (s[r ? 'right' : 'bottom'] = 0),
                      (s[r ? 'border-top-width' : 'border-left-width'] = 1),
                      i.css(t.firstChild, s),
                      i.css(t.firstChild.firstChild, {
                    ...
                    o._indicators.groups.push(c),
                      (a.triggerGroup = c),
                      o._indicators.updateTriggerGroupLabel(c),
                      o._indicators.updateTriggerGroupPositions(c);
                  })();
                }
              };
          },
      ...
      var v = function(e) {
        ...
        y = function(e, t, n) {
          return (
            (e = (function(e, t, n) {
              if (v(e)) {
                var r = l({}, e.props, { totalProgress: t, paused: !0 });
                return o.a.createElement(
                  'div',
                  null,
                  o.a.createElement(e.type, r)
                );
              }
              return e;
            })(e, t)),
            ...
            a(t, [
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    l = this.ref;
                  (a.triggerElement =
                    null === a.triggerElement ? null : a.triggerElement || l),
                    (this.scene = new p.Scene(a)),
                    this.initEventHandlers(),
                    n && this.setClassToggle(this.scene, l, n),
                    (r || o) && this.setPin(this.scene, l, r, o),
                    i && this.scene.addIndicators({ name: ' ' }),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  Array.isArray(n) && 2 === n.length
                    ? e.setClassToggle(n[0], n[1])
                    : e.setClassToggle(t, n);
                },
              },
              {
                key: 'setPin',
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    r = t.progressEvents,
                    o = void 0 === r || r;
                  ('function' === typeof n || v(m(n, 0, 'init'))) &&
            ...
            a(t, [
              {
                ...
                value: function() {
                  ...
                  return o.a.createElement(b, this.props);
                },
              },
            ]),
            t
      ...
      var E = function(e) {
          ...
          return o.a.createElement(g.Consumer, null, function(e) {
            return o.a.createElement(w, l({ controller: e }, n), t);
          });
        },
        S = n('Abe6'),
        C = o.a.createElement;
      t.default = function() {
        return C(
          ...
          C(
            E,
            { duration: '300%', triggerHook: 'onEnter' },
            C(
              S.a,
              { wrapper: C('div', { className: 'parallax' }) },
              C(
                S.b,
                { position: '0', from: { yPercent: -50 }, to: { yPercent: 0 } },
                C('img', {
                  src:
                    'https://firebasestorage.googleapis.com/v0/b/osac-a381e.appspot.com/o/osac%2Fsuat-an-cong-nghiep-bg.jpg?alt=media&token=d2563a35-56d1-47d5-a3aa-db07fcb5eeb4',
