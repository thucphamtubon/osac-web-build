  ...
  [3],
  {
    ...
    L9lV: function(t, e, r) {
      ...
      function u() {
        ...
        var P = (w.prototype = g.prototype = Object.create(b));
        function S(t) {
        ...
        function k(e, r, n) {
          ...
          return function(a, i) {
            ...
            for (n.method = a, n.arg = i; ; ) {
              ...
              var s = f(e, r, n);
              if ('normal' === s.type) {
                if (((o = n.done ? y : 'suspendedYield'), s.arg === d))
                  continue;
      ...
      function C(t, e, r) {
        return { url: P(R(t.pathname, e)), as: r ? P(R(t.pathname, r)) : r };
      }
      function N(t, e) {
              ...
              if (e) {
                if (e.__N) {
                  var r = e.url,
                    n = e.as,
                    o = e.options,
                    a = (0, p.parseRelativeUrl)(r).pathname;
                  (i.isSsr && n === i.asPath && a === i.pathname) ||
                    ...
                    i.change(
                      ...
                      r,
                      n,
                      Object.assign({}, o, { shallow: o.shallow && i._shallow })
                    );
                }
              } else {
                var u = i.pathname,
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (o = b(o, this.locale, this.defaultLocale)),
                                (i = _(x(o) ? S(o) : o, this.locale)),
                                (this._inFlightRoute = o),
                                a._h || !this.onlyAHashChange(i))
                              ) {
                                e.next = 17;
                                break;
                              }
                              return (
                                (this.asPath = i),
                                t.events.emit('hashChangeStart', o),
                                this.changeState(r, n, o, a),
                                this.scrollToHash(i),
                                this.notify(this.components[this.route]),
                                t.events.emit('hashChangeComplete', o),
                                e.abrupt('return', !0)
                              );
                            case 17:
                              return (
                            ...
                            case 22:
                              if (
                                ((l = e.sent),
                                l.__rewrites,
                                (v = (0, p.parseRelativeUrl)(n)),
                                (m = (g = v).pathname),
                                (w = g.query),
                                (v = this._resolveHref(v, s)).pathname !== m &&
                                  ((m = v.pathname),
                                  (n = (0, h.formatWithValidation)(v))),
                                (m = m
                                  ? (0, c.removePathTrailingSlash)(S(m))
                                  : m),
                                this.urlIsNew(i) || (r = 'replaceState'),
                                (P = (0, c.removePathTrailingSlash)(m)),
                                (R = a.shallow),
                                (O = void 0 !== R && R),
                                (j = _(S((j = o)), this.locale)),
                                !(0, f.isDynamicRoute)(P))
                              ) {
                                e.next = 50;
                                break;
                              }
                              if (
                                ...
                                (N = C.pathname),
                                (I = (0, d.getRouteRegex)(P)),
                                (T = (0, y.getRouteMatcher)(I)(N)),
                                (U = (A = P === N) ? k(P, N, w) : {}),
                                T && (!A || U.result))
                              ) {
                                e.next = 49;
                              ...
                              if (
                                !(
                                  (M = Object.keys(I.groups).filter(function(
                                    t
                                  ) {
                                    return !w[t];
                                  })).length > 0
                            ...
                            case 50:
                              return (
                                t.events.emit('routeChangeStart', o),
                                (e.prev = 51),
                                (e.next = 54),
                                this.getRouteInfo(P, m, w, o, O)
                              );
                            case 54:
                              if (
                                ((D = e.sent),
                              ...
                              if (
                                !(q = F.pageProps.__N_REDIRECT).startsWith('/')
                              ) {
                                e.next = 63;
                                break;
                              }
                              if (
                                ((H = (0, p.parseRelativeUrl)(q)),
                                this._resolveHref(H, s),
                                !s.includes(H.pathname))
                              ) {
                                e.next = 63;
                                break;
                              }
                              return e.abrupt(
                                'return',
                                this.change('replaceState', q, q, a)
                              );
                            case 63:
                              return (
                            ...
                            case 65:
                              return (
                                t.events.emit('beforeHistoryChange', o),
                                this.changeState(
                                  r,
                                  n,
                                  b(o, this.locale, this.defaultLocale),
                                  a
                                ),
                                (e.next = 70),
                                this.set(P, m, w, i, D).catch(function(t) {
                            ...
                            case 70:
                              ...
                              throw (t.events.emit('routeChangeError', G, i),
                              G);
                            case 73:
                              return (
                                t.events.emit('routeChangeComplete', o),
                                e.abrupt('return', !0)
                              );
                            case 78:
                              if (
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 2:
                              ...
                              throw (t.events.emit('routeChangeError', r, a),
                            ...
                            case 26:
                              return (
                                ...
                                e.abrupt(
                                  'return',
                                  this.handleRouteInfoError(e.t1, n, o, a, !0)
                                )
                              );
                            case 29:
                            case 'end':
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 27:
                              return (
                                ...
                                t.abrupt(
                                  'return',
                                  this.handleRouteInfoError(t.t1, r, n, o)
                                )
                              );
                            case 30:
                            case 'end':
              ...
              value: function(t, e) {
                var r =
                  ...
                  o = (0, c.removePathTrailingSlash)(
                    (0, s.denormalizePagePath)(r ? S(n) : n)
                  );
                return (
                  '/404' === o ||
                    '/_error' === o ||
                      ...
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 6:
                              (i = t.sent),
                                (o = this._resolveHref(o, i)).pathname !== a &&
                                  ((a = o.pathname),
                                  (e = (0, h.formatWithValidation)(o))),
                                (t.next = 11);
                              break;
                            case 11:
                              return (
                                (s = (0, c.removePathTrailingSlash)(a)),
                                (t.next = 14),
                                Promise.all([
    ...
    fvxO: function(t, e, r) {
      ...
      function o() {
        ...
        return (
          (m.prototype = w),
          a(P, 'constructor', { value: w, configurable: !0 }),
            ...
            return o().wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 4:
                    if (
                      ((n = r.res || (r.ctx && r.ctx.res)), e.getInitialProps)
                    ) {
                      t.next = 12;
                      break;
                    }
